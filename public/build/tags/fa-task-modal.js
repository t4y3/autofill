riot.tag2('fa-task-modal', '<h1>Add</h1> <div class="row"> <div class="column column-50"><input ref="task_name" type="text" placeholder="NAME" value=""></div> <div class="column column-25"><a class="button button-small" href="#" onclick="{cancel}">Cancel</a></div> <div class="column column-25"><a class="button button-small" href="#" onclick="{addTask}">Add</a></div> </div>', 'fa-task-modal,[data-is="fa-task-modal"]{ display: block; }', '', function(opts) {
